...
#ifndef MHAL_STM32_UART_H_
#define MHAL_STM32_UART_H_
...
namespace mhal{
	...
	class Tuart{
		...
		private:
			constexpr static void _init(uint32_t _baud, uint32_t _dataWidth, uint32_t _parity, uint32_t _stopBits)
			{
				...
				USART_InitStruct.DataWidth = _dataWidth;//LL_USART_DATAWIDTH_8B;
				USART_InitStruct.StopBits = _stopBits;//LL_USART_STOPBITS_1;
				USART_InitStruct.Parity = _parity;//LL_USART_PARITY_NONE;
